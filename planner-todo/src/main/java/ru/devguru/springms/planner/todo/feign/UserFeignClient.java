package ru.devguru.springms.planner.todo.feign;
...
@FeignClient(name = "planner-users", fallback = UserFeignClientFallback.class) // если не будет доступен указанный мс, fallback вызовет соответствующий метод из указанного класса (это доработка для работы Circuit Breaker)
