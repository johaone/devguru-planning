...
// настройки для связки каналов описываются в properties(github) отправляющего модуля(users) и принимающего(todo)
...
/* public interface Source {
    ...
    // создание самого исходящего канала - users по этому каналу будет оправлять сообщение в todo, что новый пользователь добавлен
