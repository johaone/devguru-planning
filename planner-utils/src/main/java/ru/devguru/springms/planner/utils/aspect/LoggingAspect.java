package ru.devguru.springms.planner.utils.aspect;
...
public class LoggingAspect {
    ...
    @Around(value = "execution(* ru.javabegin.springms.todo.todo.controller..*(..)))")
    public Object profileControllerMethods(ProceedingJoinPoint proceedingJoinPoint) throws Throwable
    {
        ...
        log.info("\n-------- Execution time of " + className + "." + methodName + " :: " + countdown.getTotalTimeMillis() + " ms");
